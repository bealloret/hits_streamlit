...
def display_set_2():
    ...
    duration_ms = st.slider("Example duration.)", min_value=0.0, max_value=16.0, step = 1.0, value = 2.92)
    ...
    time_signature = st.slider("Example time-signature. Range: from 3 to 7", min_value=3, max_value=7, value = 4)
